...
namespace SDPCRL.IBussiness
{
    public interface IDALBus
    {
        ...
        DalResult ExecuteDalMethod2(string accountId, int language, string funcId, string method,LibTable[] libTables, params object[] param);

        object ExecuteSaveMethod(string accountId, int language, string funcId, string method, LibTable[] param);
