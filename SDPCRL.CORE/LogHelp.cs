...
namespace SDPCRL.CORE
{
    public class LogHelp
    {
        ...
        public LogHelp(string configpath)
        {
            ...
            FileOperation.FilePath = string.Format(@"{0}BWYLog.config", configpath);
        ...
        //private void DoDeleteFile(string filenm)
        //{
        //    //string filenm = System.DateTime.Now.ToString(LogConfig.FileNmDateFormatter);
        //    string filepath = string.Format(@"{0}\{1}\{2}", this._configpath, LogConfig.FilePath, filenm);
        //    FileOperation FileOperation = new FileOperation();
        //    FileOperation.Encoding = LibEncoding.UTF8;
        //    FileOperation.FilePath = filepath;
        ...
        //}
        private void DoDeleteFileBatch(List<string> files)
        {
